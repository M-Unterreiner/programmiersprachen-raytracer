...
TEST_CASE ("Reader")
{
  ...
  */
  SECTION("set_material")
  {
    ...
    std::string new_material = "define material red 1 0 0 0 0 0 0 0 0 10";
    Reader new_reader{};
  ...
  SECTION("set_box")
  {
    ...
    std::string new_box = "define shape box rbottom -100 -80 -200 100 80 -100 red";
    Reader new_reader{};
  ...
  SECTION("set sphere")
  {
    ...
    std::string new_sphere = "define shape sphere bsphere 0 0 -100 50 blue";
    Reader new_reader{};
